...
export const CONTRACTS = {
  ...
  // Updated: 2026-01-04 - must match ENVIO_ORACLE_ADDRESS in agents/.env
  ENVIO_ORACLE: process.env.NEXT_PUBLIC_ENVIO_ORACLE_ADDRESS || "0xA2400EFe3d7a9E2281F32A66Df18CFFE651c69f3",
